...
export default function YearsWrapper() {
    ...
    return (
        <div className='flex justify-center text-white p-8 text-sm'>
            It is {dateState?.month} {dateState?.day} in {dateState?.year}, am still wondering after graduation why I decided to become a web developer and obsessed with React.js.
        </div>
    )
}
